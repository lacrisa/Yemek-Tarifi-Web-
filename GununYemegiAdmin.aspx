            ...
            <ItemTemplate>
                <table class="auto-style9">
                    <tr>
                        ...
                        <td class="auto-style21"><a href='<%# Eval("YemekId", "YemekDuzenle.aspx?YemekId={0}") %>'>
                            <asp:Image ID="Image3" runat="server" Height="30px" ImageUrl="~/iconlar/chose.png" Width="30px" />
                            </a></td>
                    </tr>
                </table>
            </ItemTemplate>
